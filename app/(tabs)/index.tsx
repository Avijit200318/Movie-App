...
import { getTreandingMovies } from "@/services/appwrite";
...
export default function Index() {
  ...
  const {data: trendingMovies, loading: trendingMovieLoading, error: trendingMovieError} = useFetch(getTreandingMovies);
      ...
      <ScrollView className="flex-1 px-5 ">
        ...
        {moviesLoading || trendingMovieLoading ? (
          ...
          moviesError || trendingMovieError ? (
            <Text>{moviesError?.message || trendingMovieError?.message}</Text>
          ) : (
